...
public final class DateUtil {
    ...
    public static String getDateFormat(Date date) {
        return getDateFormat(date, AriesConstant.SPECIFIC_DATE_FORMAT_PATTERN);
    }
    public static String getDateFormatLong(Date date) {
        return getDateFormat(date, AriesConstant.LONG_DATE_PATTERN);
    }

    public static String getDateShortFormat(Date date) {
        return getDateFormat(date, AriesConstant.SHORT_DATE_PATTERN);
    }
    ...
    public static Date parseDate(String dateStr) {
        return parseDate(dateStr, AriesConstant.DEFAULT_DATE_FORMAT_PATTERN);
    }
